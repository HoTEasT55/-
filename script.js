document.addEventListener('DOMContentLoaded', () => {
  ...
  form.addEventListener('submit', async (e) => {
    ...
    const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbymcbyfe_kj0IzPM-_O26KOOkYqd2it1_Q3NsNQws2qcMFzzocjlPI6g81G6X53ObPrRw/exec';
  ...
  if (calendarBtn) {
    calendarBtn.addEventListener('click', function(e) {
      ...
      var googleUrl = 'https://calendar.google.com/calendar/render?action=TEMPLATE' +
        ...
        '&details=' + encodeURIComponent('Сбор гостей в 13:00. Церемония в 14:30. Банкетный зал «Зеленый Берег»') +
